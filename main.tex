...
Since the reparameterised negative binomial distribution has parameters with asymptotic limits, then $ k $ will not vary between the distributions fitted to $ X $ and $ Z $. This implies that we can obtain both $ R_0 $ and $ k $ from the distribution fitted to $ X $.
