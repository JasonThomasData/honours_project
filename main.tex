...
\begin{table}[]
	\begin{tabular}{|l|l|l|ll|l|}
		\hline
		\multirow{2}{*}{\textbf{Tick species}} & \multirow{2}{*}{\textbf{Host species}} & \multirow{2}{*}{\textbf{Year}} & \multicolumn{2}{c|}{\textbf{Perkins et al, 2003}}                                        & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Johnstone\\-Robertson\\ et al 2020\end{tabular}}} \\ \cline{4-6} 
		&                                        &                                & \multicolumn{1}{c|}{\textbf{Aggregation}} & \multicolumn{1}{c|}{\textbf{Co-aggregation}} & \multicolumn{1}{c|}{\textbf{Co-aggregation}}                                                            \\ \hline
		\textit{I. trianguliceps}              & \textit{Common shrew}                  & 2004                           & \multicolumn{1}{l|}{0.651}                & 0.942                                        & 0.956                                                                                                   \\ \hline
		\textit{I. trianguliceps}              & \textit{Common shrew}                  & 2005                           & \multicolumn{1}{l|}{0.872}                & 0.968                                        & 0.975                                                                                                   \\ \hline
		\textit{I. trianguliceps}              & \textit{Field vole}                    & 2005                           & \multicolumn{1}{l|}{0.809}                & 0.98                                         & 0.98                                                                                                    \\ \hline
		\textit{I. ricinus}                    & \textit{Common shrew}                  & 2004                           & \multicolumn{1}{l|}{0.879}                & 0.98                                         & 0.98                                                                                                    \\ \hline
		\textit{I. ricinus}                    & \textit{Field vole}                    & 2005                           & \multicolumn{1}{l|}{0.945}                & 0.98                                         & 0.98                                                                                                    \\ \hline
	\end{tabular}
...
\subsection{Estimates for \texorpdfstring{$ \alpha $}{alpha} and the effect on \texorpdfstring{$ R_0 $}{R0}}

Now that we have estimates for the sample mean of the co-aggregation data, obtained from subsets of the Kielder Forest data, we can obtain a particular estimate for $ R_0 $, based on some $ \alpha $ that we nominate based on \eqref{alphaDef}. These estimates will be illustrative only; researchers who wish to calculate the probability that a new outbreak becomes extinct would do well to provide better estimates about their particular tick species, host species, pathogen and environmental conditions.
...
\begin{table}[h!]
	\begin{tabular}{|lrl|}
		...
		\\ \hline
	\end{tabular}
	\caption{$\alpha$ estimates for a generic combination of tick species, host species, pathogen and environmental conditions.}
	\label{table:kielderForestParamEstimates}
\end{table}

Based on the estimates provided in table \ref{table:kielderForestParamEstimates}, $ \alpha = cv\sigma = 0.19 $. While this estimate is based on some naive assumptions, it is useful for illustration purposes and for determining an example of probability of extinction and simulations in a later section. REMOVE THIS IF YOU DON'T GET TO RUN THE SIMULATIONS.

However, we can understand the effect on $ R_0 $ even if we do not have a particular $ \alpha $. We can also understand the relationship between $ \alpha $ and $ R_0 $ with the simple linear equation \eqref{FindingR0FromCoaggregationMean}. Since a chain of transmission will certainly become extinct if $ R_0 < 1 $, then we are interested in the case where $ R_0 > 1 $. Other words, what is the minimum value of $ \alpha $ such that a chain of transmissions might persist? This is found with:
...
% The use of Kielder Forest data makes the assumption that small vertebrate hosts will live for one year. This is reflected by using the data from 2004 and 2005 as two distinct groups of vertebrate hosts. 
